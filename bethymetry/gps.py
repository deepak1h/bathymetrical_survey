...
class gps(Thread):
    ...
    def GPS_Info(self):
        ...
        if self.locked():           
            self.__lat_in_degrees = self.convert_to_degrees(self.__nmea_lat)
            self.__long_in_degree = self.convert_to_degrees(self.__nmea_long)
    ...
    def is_working(self):
        ...
        if tim2>tim:
            ...
            return False
    def location(self):
        self.__location = [self.__curr_time,self.__long_in_degree,self.__locked,self.__satellite]
